...
JPush-SDK-iOS is available through [CocoaPods](http://cocoapods.org). To install
...
wanyakun, wanyakun@vip.qq.com

## License

JPush-SDK-iOS is available under the MIT license. See the LICENSE file for more info.
